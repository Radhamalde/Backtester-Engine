...
class Metrics():
    ...
    def get_initial_capital(self): # get before engine run in main (probably cleaner way to do this to always get initial captial value)
        return self.portfolio.cash # thjis is wrong and messing up total and avg returns !!!!
    ...
    def get_win_rate(self): # 100* profitable trades/total trades !!! STILL NEED TO IMPLEMENT
        return self.portfolio.profitable_trades / self.get_total_trades()
